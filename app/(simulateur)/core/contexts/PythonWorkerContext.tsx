...
export function PythonWorkerProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleMessage = (e: MessageEvent) => {
      ...
      console.log('[PythonWorkerProvider] Message reçu du worker:', type, { scriptName, callbackKey });
      ...
      switch (type) {
        ...
        case 'error':
          console.error('[PythonWorkerProvider] Erreur du worker:', error, { scriptName, callbackKey });
          if (callbackKey) {
  ...
  const loadScript = useCallback((scriptName: string): Promise<void> => {
    ...
    if (loadingScripts.current.has(scriptName)) {
      console.log('[PythonWorkerProvider] loadScript: Script en cours de chargement, attente de:', scriptName);
      return new Promise((resolve, reject) => {
        ...
        const checkInterval = setInterval(() => {
          ...
          if (loadedScripts.has(scriptName)) {
            ...
            console.log('[PythonWorkerProvider] loadScript: Script maintenant disponible:', scriptName);
            resolve();
    ...
    console.log('[PythonWorkerProvider] loadScript: Envoi demande de chargement pour:', scriptName);
    return new Promise((resolve, reject) => {
  ...
  const runPython = useCallback((
    ...
    console.log('[PythonWorkerProvider] runPython: Exécution de', functionName, 'depuis', scriptName, 'avec params:', params);
